...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/runtype-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14090&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/runtype-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `runtype` can be installed with:

```
conda install runtype
```

It is possible to list all of the versions of `runtype` available on your platform with:
